# Code developed by Marina Nousi implementing Branch and Bound with BestFS and Minimum Distance heuristic.
...
if __name__ == "__main__":
    ...
    results_file = f"results_BestFS_MinDistance_{os.path.basename(folder_path)}.txt"
