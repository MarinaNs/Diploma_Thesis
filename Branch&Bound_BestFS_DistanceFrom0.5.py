# Code developed by Marina Nousi implementing Branch and Bound with BestFS and Distance from 0.5 heuristic.
...
if __name__ == "__main__":
    ...
    results_file = f"results_BestFS_heuristic2_{os.path.basename(folder_path)}.txt"
